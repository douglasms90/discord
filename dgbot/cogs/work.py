...
class work(commands.Cog):
    ...
    async def fin(self, ctx, *args):
        tt = 133611.85
        data=[
            {'tp':'rf',                 'nm':'inv',     'pm':79.18,     'qt':1,         'rc':'',    'pa':79.82      }, #1
            {'tp':'rf',                 'nm':'tdi',     'pm':100,       'qt':220,       'rc':'',    'pa':22481.61   }, #2
            {'tp':'rf',	                'nm':'slc 29',  'pm':12874.14,  'qt':1.31,      'rc':'',    'pa':18561.99   }, #3 01/03/2029
            {'tp':'rf',	                'nm':'lci',     'pm':1000,      'qt':20,        'rc':'',    'pa':21001.03   }, #4 08/05/2023 > 08/05/2024
            {'tp':'rf',	                'nm':'cdb',     'pm':1000,      'qt':10,        'rc':'',    'pa':12124.74   }, #5 05/08/2022 > 05/08/2024
            {'tp':'rf',	                'nm':'pre 25',  'pm':738.14,    'qt':3.38,      'rc':'',    'pa':3073.94    }, #6 14/04/2022 > 01/01/2025
            {'tp':'rf',	                'nm':'inf 26',  'pm':3146.81,   'qt':0.79,      'rc':'',    'pa':2890.15    }, #7 26/04/2022 > 15/08/2026
            ...
            {'tp':'bdrs',	        	'nm':'baba34',  'pm':17.47,     'qt':80,        'rc':'',    'pa':23         }, #32  25
